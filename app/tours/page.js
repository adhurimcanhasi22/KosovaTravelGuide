...
export default function ToursPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* FAQ Section */}
      <section className="section bg-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Common questions about our Kosovo tours
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                Our standard tours have a maximum of 8-12 people, depending on
                the tour. We believe smaller groups provide a better experience.
                Private tours are also available for individuals, families, or
                larger groups.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                For most tours, cancellations made at least 48 hours before the
                start time receive a full refund. Cancellations less than 48
                hours in advance are not refundable. Multi-day tours may have
                different policies, which will be specified in the tour details.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                Day tours typically include lunch at a traditional restaurant.
                Multi-day tours include breakfast daily, and selected lunches
                and dinners as specified in the itinerary. We can accommodate
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                ...
                depending on the location and tour type. All accommodations are
                clean, comfortable, and carefully selected to enhance your
                experience of Kosovo. Single room supplements are available for
                solo travelers.
              </p>
            </div>
          </div>
